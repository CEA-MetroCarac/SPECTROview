...
class Spectrums(QObject):
    ...
    def __init__(self, settings, ui, common, visu):
        ...
        self.spectra_view_widget = SpectraViewWidget()
        self.ui.toolbar_layout.addWidget(self.spectra_view_widget.view_options_button)
        self.ui.fig_canvas_layout.addWidget(self.spectra_view_widget.canvas)
        self.ui.toolbar_layout.addWidget(self.spectra_view_widget.toolbar)
    ...
    def recreate_spectra_widget(self):
        ...
        self.spectra_view_widget.create_spectra_plot_widget()
    ...
    def plot(self):
        ...
        # Clear previous plot
        self.spectra_view_widget.ax.clear()
        ...
        # Plot data
        self.spectra_view_widget.ax.plot(x, y)

        self.spectra_view_widget.refresh_plot()
        
        # Set grid and layout
        self.spectra_view_widget.ax.grid(True, linestyle='--', linewidth=0.5, color='gray')
        self.spectra_view_widget.figure.tight_layout()
        
        # Draw canvas
        self.spectra_view_widget.canvas.draw()
        print("Canvas drawn")
