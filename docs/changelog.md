...
- Added intelligent multi-level data sorting that strictly prioritizes user-defined category orders for consistent legend colors/labels within legen box, while automatically sorting numerical X-axes for accurate line rendering.
