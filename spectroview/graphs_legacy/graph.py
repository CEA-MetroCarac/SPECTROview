...
class Graph(QWidget):
    ...
    def create_plot_widget(self, dpi, layout=None):
        ...
        # Note: compressed layout is incompatible with subplots_adjust and tight_layout
        # The compressed layout engine handles spacing automatically
    ...
    def plot(self, df):
        ...
        # Note: tight_layout() is not needed with compressed layout engine
        self.canvas.draw_idle()
    ...
    def _plot_primary_axis(self, df):
        ...
        # Trim colors/markers to match actual number of hue categories if z is used
        ...
        for y in self.y:
            if self.plot_style == 'point':
                ...
                if self.z:
                    ...
                    sns.scatterplot(data=df, x=self.x, y=y, ax=self.ax,
