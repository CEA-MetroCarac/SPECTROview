...
class MapViewer(QWidget):
    ...
    def update_xrange_slider(self, xmin, xmax, current_min, current_max):
        # --- OPTIMIZATION: Block Signals ---
        self.x_range_slider.blockSignals(True)
        ...
        # --- Unblock Signals ---
        self.x_range_slider.blockSignals(False)
