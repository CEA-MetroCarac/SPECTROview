...
from PySide6.QtWidgets import QDialog, QTableWidgetItem, QVBoxLayout,  QTextBrowser, \
    QComboBox, QListWidgetItem, QMessageBox, QDialog, QVBoxLayout, QListWidget, QAbstractItemView, QApplication
...
def copy_fig_to_clb(canvas, size_ratio=None):
    ...
    Args:
        canvas: FigureCanvasQTAgg object from matplotlib
        size_ratio: Optional tuple (width, height) in inches to resize figure before copying
    """
    if not canvas:
