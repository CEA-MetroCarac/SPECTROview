<div style="width: 100%; overflow: hidden; padding-bottom: 10px;">
  ...
  <div style="text-align: right;">
    ...
    <p align="right" style="margin-top: 5px; color: gray; font-size: 0.9em; text-align: right;"><i>(Last updated: 10 July 2026)</i></p>
  </div>
</div>
<div style="clear: both;"></div>

<br>
<p>Welcome to the official documentation for <code>SPECTROview</code>.<br>
Explore the sections on the left-hand side to learn more about the features and capabilities of the software.</p>
...
- **Changelog:** Review the latest updates and release notes [here](https://cea-metrocarac.github.io/SPECTROview/changelog/).
