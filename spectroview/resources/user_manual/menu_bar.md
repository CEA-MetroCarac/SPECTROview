...
| Button | Function |
|--------|----------|
| ![Open](../user_manual_images/menu_bar/open.png) | **Open**: Loads any supported data type. The application automatically detects the file format and switches to the appropriate workspace. |
