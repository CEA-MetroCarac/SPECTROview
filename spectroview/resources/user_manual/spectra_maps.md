...
The `SpectraList` displays all loaded discrete spectra (in the `Spectra` workspace) or all spectra for the currently selected map (in the `Maps` workspace) (see fig below).
...
<div align="center">
  <img src="../user_manual_images/Spectra_Maps/spectralist.png" alt="SpectraList Widget" width="400"><br>
  <i>The <code>SpectraList</code> alongside the progress bar in the <code>Maps</code> workspace.</i>
</div>
...
The **Progress Bar** under the `SpectraList` displays real-time fitting progress (%), number of converged spectra, and elapsed time (s). A "Stop" button is provided to safely halt an ongoing fitting process.


#### **2.1. Cross-Workspace Transfer**
...
#### **3.1. `SpectraViewer` with Interactive Mouse Controls**
...
#### **3.2. Toolbar Buttons and View Options**

| Button | Function |
|--------|----------|
| ![Rescale](../user_manual_images/Spectra_Maps/rescale.png) | **Rescale**: Automatically rescales the plot axes to fit the current data. Shortcut: `Ctrl + R`. |
...
The `FitModelBuilder` tab is where you configure your spectral fit models. It is divided into three main panels: `Fitting`, `PeakTable`, and `FitModelControl`, each explained in the following sections.

You can use global fitting parameters or adjust fitting parameters in the `Settings Panel` (see the "Settings" section for details).

<div align="center">
  <img src="../user_manual_images/Spectra_Maps/fit_model_builder.png" alt="Fit Model Builder UI" width="800"><br>
  <i>The <code>FitModelBuilder</code> tab featuring: (1) The <code>Fitting</code> panel (left), (2) The <code>PeakTable</code> panel (top-right), and (3) The <code>FitModelControl</code> panel (bottom-right).</i>
</div>
...
<div align="center">
  <img src="../user_manual_images/Spectra_Maps/peak_table.png" alt="Peak Table Panel" width="800"><br>
   <i>The <code>PeakTable</code> panel displaying peak parameters and constraints.</i>
</div>

**Add Constraints for Fit Model**:

**Fix**: Check the "fix" box to freeze the parameter value, preventing the optimizer from changing it during the fit.
...
<div align="center">
  <img src="../user_manual_images/Spectra_Maps/peak_table_max_min.png" alt="Peak Table Constraints" width="800"><br>
   <i>Example 1: Activate the "Limits" option under the peak table and set "min" and "max" values for each fit parameter.</i>
</div>
...
<div align="center">
  <img src="../user_manual_images/Spectra_Maps/fit_control_panel.png" alt="Fit Model Control Panel" width="500"><br>
   <i>The <code>FitModelControl</code> panel.</i>
</div>
...
#### **5.1. Splitting Filename Features**
