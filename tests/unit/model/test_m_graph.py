...
ALL_SAVE_KEYS = {
    ...
    'df_name', 'x', 'y', 'z', 'y2', 'y3', 'x2', 'xmin', 'xmax', 'ymin', 'ymax', 'zmin',
    'zmax', 'y2min', 'y2max', 'y3min', 'y3max', 'x2min', 'x2max', 'xlogscale',
    'ylogscale', 'y2logscale', 'y3logscale', 'x2logscale', 'plot_title', 'xlabel',
...
CUSTOM_VALUES = {
    ...
    'legend_properties': [{'label': 'A', 'marker': 'o', 'color': '#E31A1C'}],
    'legend_bbox': [0.5, 0.5],
    ...
    'show_bar_plot_error_bar': True, 'join_for_point_plot': True, 'dodge_point_plot': False,
