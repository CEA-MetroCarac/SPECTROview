...
ALL_SAVE_KEYS = {
    ...
    'title_fontsize', 'axis_label_fontsize', 'tick_label_fontsize', 'colorbar_fontsize',
    'plot_subtitle', 'figure_facecolor', 'figure_margins', 'spines_visible',
...
class TestMGraphInitialization:
    ...
    def test_default_properties(self):
        ...
        assert graph.plot_width == 408
        assert graph.plot_height == 327
